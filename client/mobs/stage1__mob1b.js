...
export const stage1__mob1b__boss1 = patch(stage1__mob1, {
  GRAY_TINT: 0x000000,
  COLOR_TINT: 0x000000,
  AMBIENT_TINT: [0x7a0000, 1],
  SPECIAL_TINT: 0x7a0000,
  ADD_COLOR_TINT: 0x000000,
  ADD_AMBIENT_TINT: 0x7a0000,
  ADD_SPECIAL_TINT: 0x7a0000,
});
export const weapon__stage1__mob1b__boss1__rightHand__default = patch(
  weapon__stage1__mob1__rightHand__default, {
    createView() {
      const view = makeHSL(hslMap['stage1__mob1--hand'], 0.2, 0.8, [
        0x000000, 0x000000, [0x7a0000, 1],
        0x000000, 0x000000, 0x7a0000, 0x7a0000
      ]);
      return view;
    }
  });
